            ...
            <tbody class="text-gray-700">
                @forelse ($applications as $app)
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4">{{ \Carbon\Carbon::parse($app->submitted_at)->format('d/m/Y H:i') }}</td>
                        ...
                        <td class="py-3 px-4 flex gap-2">
                            ...
                            <a href="{{ route('admin.applications.show', $app->application_id) }}"
                               class="bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold py-1 px-3 rounded-full transition-colors">
                                ดูรายละเอียด
                            </a>
