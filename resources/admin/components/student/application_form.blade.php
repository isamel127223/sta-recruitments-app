                ...
                <div class="p-6 md:p-8 text-white">
                    ...
                    <form method="POST" action="{{ route('application.form.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                            ...
                            <div>
                                <x-input-label for="dob" value="วัน/เดือน/ปีเกิด (ค.ศ.)" class="text-yellow-500" />
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center text-yellow-500"><input type="radio" name="education_status" value="กำลังศึกษาอยู่ ปวส." class="mr-2 text-sta-yellow focus:ring-sta-yellow" {{ old('education_status') == 'กำลังศึกษาอยู่ ปวส.' ? 'checked' : '' }}> กำลังศึกษาอยู่ระดับอนุปริญญา/ปวส.</label>
                                <label class="flex items-center text-yellow-500"><input type="radio" name="education_status" value="สำเร็จการศึกษา ปวส." class="mr-2 text-sta-yellow focus:ring-sta-yellow" {{ old('education_status') == 'สำเร็จการศึกษา ปวส.' ? 'checked' : '' }}> สำเร็จการศึกษาระดับอนุปริญญา/ปวส. แล้ว</label>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                            <div>
                                <x-input-label for="graduation_year" value="ปีการศึกษาที่สำเร็จ (กรณีจบแล้ว)" class="text-yellow-500" />
                             ...
                             <div>
                                <x-input-label for="school_name" value="ชื่อโรงเรียน/สถาบันการศึกษา" class="text-yellow-500" />
                            ...
                            <div>
                                <x-input-label for="school_province" value="จังหวัดของโรงเรียน" class="text-yellow-500" />
                            ...
                            <div>
                                <x-input-label for="school_major" value="แผนการเรียน/แผนก (เช่น วิทย์-คณิต)" class="text-yellow-500" />
                            ...
                            <div>
                                <x-input-label for="gpax" value="เกรดเฉลี่ยสะสม (GPAX)" class="text-yellow-500" />
                            ...
                            <div>
                                <x-input-label value="GPAX (สำหรับผู้กำลังศึกษา)" class="text-yellow-500" />
                                <div class="mt-1 space-y-1">
                                    <label class="flex items-center text-yellow-500"><input type="radio" name="gpax_type" value="4 ภาค" class="mr-2 text-sta-yellow focus:ring-sta-yellow" {{ old('gpax_type') == '4 ภาค' ? 'checked' : '' }}> 4 ภาคการศึกษา</label>
                                    <label class="flex items-center text-yellow-500"><input type="radio" name="gpax_type" value="5 ภาค" class="mr-2 text-sta-yellow focus:ring-sta-yellow" {{ old('gpax_type') == '5 ภาค' ? 'checked' : '' }}> 5 ภาคการศึกษา</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <x-input-label for="faculty" value="คณะ" class="text-yellow-500" />
                        ...
                        <div class="mb-4">
                            <x-input-label value="สาขาวิชา (เลือกได้ 1 สาขา)" class="text-yellow-500 mb-2" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div>
                                <x-input-label for="id_card_file" value="1. สำเนาบัตรประจำตัวประชาชน (บังคับ)" class="text-yellow-500" />
                            ...
                            <div>
                                <x-input-label for="transcript_file" value="2. สำเนาใบระเบียนผลการเรียน (บังคับ)" class="text-yellow-500" />
                            ...
                            <div>
                                <x-input-label for="graduation_certificate_file" value="3. สำเนาใบรับรองการสำเร็จการศึกษา (ถ้ามี)" class="text-yellow-500" />
                            ...
                            <div>
                                <x-input-label for="other_documents_file" value="4. เอกสารอื่นๆ (ถ้ามี เช่น เกียรติบัตร)" class="text-yellow-500" />
