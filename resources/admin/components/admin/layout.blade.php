...
<body class="bg-gray-200">
    ...
    <div class="flex min-h-screen">
                ...
                <ul>
                    ...
                    <li class="mb-3">
                        <a href="{{ route('admin.applications.index') }}" 
                           class="flex items-center p-3 rounded-lg hover:bg-gray-700 transition-colors
                                  {{ request()->routeIs('admin.applications.*') ? 'bg-sta-yellow text-black' : '' }}">
                            <span class="mr-3">📄</span>
                            ข้อมูลการสมัคร
                        </a>
                    </li>
                    ...
                    <li class="mb-3">
                        <a href="{{ route('admin.interest-forms.index') }}" 
                           class="flex items-center p-3 rounded-lg hover:bg-gray-700 transition-colors
                                  {{ request()->routeIs('admin.interest-forms.index') ? 'bg-sta-yellow text-black' : '' }}">
                            <span class="mr-3">📝</span>
                            ข้อมูลความสนใจ
                        </a>
                    </li>
        ...
        <main class="flex-1 p-8">
            ...
            @if (session('status') && !request()->routeIs('admin.applications.index'))
    ...
    <!-- --- [เพิ่มใหม่] Footer สำหรับ Admin --- -->
    <footer class="w-full text-center p-4 text-gray-500 bg-gray-200 border-t border-gray-300">
        <div class="text-xs">
            © {{ date('Y') }} STA Admin Panel
        </div>
    </footer>
    <!-- ----------------------------------- -->
